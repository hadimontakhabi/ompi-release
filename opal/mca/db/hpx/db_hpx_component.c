...
static int db_hpx_component_query(opal_db_base_module_t **module,
                                  ...
                                  int *fetch_priority,
                                  bool restrict_local);
static int db_hpx_component_close(void);
static int db_hpx_component_register(void);

/*
 * Instantiate the public struct with all of our public information
 * and pointers to our public functions in it
 */
opal_db_base_component_t mca_db_hpx_component = {
    {
        ...
        db_hpx_component_open,
        db_hpx_component_close,
        NULL,
        db_hpx_component_register
    },
    {
        /* The component is checkpoint ready */
        MCA_BASE_METADATA_PARAM_CHECKPOINT
    },
    db_hpx_component_query
};
...
static int db_hpx_component_query(opal_db_base_module_t **module,
                                  ...
                                  bool restrict_local)
{
  *store_priority = hpx_store_priority;
  *fetch_priority = hpx_fetch_priority;
  *module = &opal_db_hpx_module;
  return OPAL_SUCCESS;
}
